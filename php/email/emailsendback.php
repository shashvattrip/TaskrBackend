...
require_once('/facebook/php-sdk/facebook.php');
  		...
  		$loginUrl = $facebook->getLoginUrl(
		    array(
		        ...
		        'redirect_uri' => 'http://' . $ip . '/github/taskrbackend/login.php',
...
$mail->Body = "$project_id ----- Hello, Login to Taskr by clicking on the following link : $loginUrl";
